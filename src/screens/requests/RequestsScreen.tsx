...
const styles = StyleSheet.create({
  ...
  chipTextActive: { color: '#fff', fontFamily: 'Outfit-SemiBold' },
  ...
  withdrawText: { color: '#D20236', fontSize: 14, fontFamily: 'Outfit-Bold' },
  ...
  profileBtnText: { fontSize: 14, color: '#333', fontFamily: 'Outfit-Bold' },
  removeBtn: {
    flex: 1,
  ...
  removeText: { color: '#D20236', fontSize: 14, fontFamily: 'Outfit-Bold' },
  content: { flex: 1 },
  loader: { marginTop: 40 },
});
