...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 15, fontFamily: 'Outfit-Bold', color: '#000', marginBottom: 12, marginTop: 6 },
  reasonRow: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    borderWidth: 1, borderColor: '#e0e0e0', borderRadius: 10,
    paddingHorizontal: 14, paddingVertical: 14, marginBottom: 10,
  },
  reasonText: { fontSize: 14, color: '#333', fontFamily: 'Outfit-Medium' },
  textArea: {
  ...
  errorText: { fontSize: 13, color: '#D20236', marginBottom: 14, fontFamily: 'Outfit-Medium' },
  cancelBtn: {
    borderWidth: 1, borderColor: '#e0e0e0', borderRadius: 10,
    paddingVertical: 15, alignItems: 'center', marginBottom: 12,
  },
  cancelText: { fontSize: 15, fontFamily: 'Outfit-SemiBold', color: '#333' },
  deleteBtn: {
    borderWidth: 1, borderColor: '#D20236', borderRadius: 10,
    paddingVertical: 15, alignItems: 'center',
  },
  deleteBtnDisabled: { borderColor: '#e9a9b6' },
  deleteText: { fontSize: 15, fontFamily: 'Outfit-Bold', color: '#D20236' },
