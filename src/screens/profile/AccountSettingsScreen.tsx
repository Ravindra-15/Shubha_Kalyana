...
const styles = StyleSheet.create({
  ...
  sectionTitleDanger: { fontSize: 12, color: '#D20236', fontFamily: 'Outfit-Bold', marginBottom: 8, letterSpacing: 0.5 },
  ...
  logoutText: { fontSize: 15, fontFamily: 'Outfit-Bold', color: '#D20236' },
});