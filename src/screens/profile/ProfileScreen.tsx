...
import {
  ArrowLeft, Settings, BadgeCheck, Edit3, Bookmark, CreditCard, Download, Heart, ChevronRight, Crown, Eye, Users,
...
const styles = StyleSheet.create({
  ...
  summaryLabel: { fontSize: 11, color: '#888', fontFamily: 'Outfit-Bold' },
  summaryValue: { fontSize: 13, color: '#000', fontFamily: 'Outfit-Bold', marginTop: 3 },
  ...
  completionLabel: { fontSize: 14, fontFamily: 'Outfit-Bold', color: '#000' },
  completionPercent: { fontSize: 14, fontFamily: 'Outfit-Bold', color: '#D20236' },
  ...
  completeBtnText: { fontSize: 14, fontFamily: 'Outfit-Bold', color: '#D20236' },
  ...
  planName: { fontSize: 15, fontFamily: 'Outfit-Bold', color: '#000' },
  planHint: { fontSize: 12, color: '#888', marginBottom: 10 },
  upgradeBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
    backgroundColor: '#D20236', borderRadius: 8, paddingVertical: 12,
  },
  upgradeBtnText: { fontSize: 14, fontFamily: 'Outfit-Bold', color: '#fff' },
  quickTitle: { fontSize: 14, color: '#888', fontFamily: 'Outfit-Bold', marginBottom: 10, marginTop: 4 },
  ...
  actionLabel: { flex: 1, fontSize: 14, color: '#333', fontFamily: 'Outfit-Medium' },
});
