...
const styles = StyleSheet.create({
  ...
  saveBtnText: { fontSize: 14, fontFamily: 'Outfit-Bold', color: '#fff' },
  ...
  changePhotoText: { fontSize: 13, fontFamily: 'Outfit-SemiBold', color: '#D20236', marginTop: 8 },
  verifyProfileBtn: {
    minWidth: 150,
    minHeight: 42,
    borderRadius: 10,
  ...
  verifyProfileText: { fontSize: 14, fontFamily: 'Outfit-Bold', color: '#fff' },
  profileNameRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  profileName: { flexShrink: 1, fontSize: 16, fontFamily: 'Outfit-Bold', color: '#000' },
  sectionTitle: {
    fontSize: 12,
    color: '#8b919c',
  ...
  lockedText: { fontSize: 14, color: '#5f6773', fontFamily: 'Outfit-SemiBold' },
  requestChangeBtn: {
    marginTop: 8,
    borderWidth: 1,
    borderColor: '#D20236',
  ...
  requestChangeText: { fontSize: 13, fontFamily: 'Outfit-Bold', color: '#D20236' },
  pendingBadge: {
    marginTop: 8,
  ...
  pendingBadgeText: { fontSize: 12, fontFamily: 'Outfit-SemiBold', color: '#8a5a00' },
  ...
  checkLabel: { fontSize: 14, color: '#333', fontFamily: 'Outfit-SemiBold' },
  group: { marginBottom: 14 },
  groupTitle: { fontSize: 14, fontFamily: 'Outfit-Bold', color: '#111', marginBottom: 10 },
  ...
  modalTitle: { fontSize: 16, color: '#111', fontFamily: 'Outfit-Bold' },
  searchInput: {
    borderWidth: 1,
    borderColor: '#e0e0e0',
    borderRadius: 10,
  ...
  doneText: { color: '#fff', fontSize: 15, fontFamily: 'Outfit-Bold' },
  saveChangesBtn: { backgroundColor: '#D20236', borderRadius: 10, paddingVertical: 15, alignItems: 'center', marginTop: 20 },
  saveChangesText: { fontSize: 15, fontFamily: 'Outfit-Bold', color: '#fff' },
});
